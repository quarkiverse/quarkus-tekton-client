...
class TektonClientProcessor {
    ...
    public void addDependencies(BuildProducer<IndexDependencyBuildItem> indexDependency) {
        ...
        indexDependency.produce(new IndexDependencyBuildItem("io.fabric8", "tekton-model-triggers-v1alpha1"));
        indexDependency.produce(new IndexDependencyBuildItem("io.fabric8", "tekton-model-triggers-v1beta1"));
